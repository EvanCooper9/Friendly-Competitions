...
//                    guard let id = selectedID(from: ranges) else { return }
//                    withAnimation {
...
//    func selectedID(from ranges: [CompetitionHistoryDateRange]) -> CompetitionHistoryDateRange.ID? {
//        ranges.first(where: { $0.selected == true })?.id
//    }
