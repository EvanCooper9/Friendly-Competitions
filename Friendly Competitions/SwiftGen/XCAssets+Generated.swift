...
internal enum Asset {
  internal enum Colors {
    internal enum Branded {
      internal static let blue = ColorAsset(name: "Branded/Blue")
      internal static let green = ColorAsset(name: "Branded/Green")
      internal static let red = ColorAsset(name: "Branded/Red")
    }
  }
